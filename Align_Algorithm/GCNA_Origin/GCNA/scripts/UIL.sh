    ...
    do
        ...
        do 
            ...
            do
                ...
                --pale_map_epochs 100 \
                --embedding_dim 250 \
                --cuda > output/GCNA/econ_d2_ee${ee}_ls${ls}_msab${msab}_jump
    ...
    do
        ...
        do 
            ...
            do
                ...
                --pale_map_epochs 100 \
                --embedding_dim 250 \
                --cuda > output/GCNA/econ_d2_ee${ee}_ls${ls}_msab${msab}
    ...
    do
        ...
        do 
            ...
            do
                ...
                --pale_map_epochs 100 \
                --embedding_dim 250 \
                --cuda > output/GCNA/econ_d2_ee${ee}_ls${ls}_msab${msab}_sep
    ...
    do
        ...
        do 
            ...
            do
                ...
                --pale_map_epochs 100 \
                --embedding_dim 250 \
                --cuda > output/GCNA/econ_d2_ee${ee}_ls${ls}_msab${msab}_sep_jump
...
parser_GCNA = subparsers.add_parser("GCNA", help="GCNA algorithm")
    ...
    parser_GCNA.add_argument('--embedding_dim',       default=300,         type=int)
    parser_GCNA.add_argument('--emb_epochs',    default=500,        type=int)
    parser_GCNA.add_argument('--lr', default=0.1, type=float)
    parser_GCNA.add_argument('--neg_sample_size',  default=5, type=int)
    parser_GCNA.add_argument('--loss', type=str, default='n')
    parser_GCNA.add_argument('--num_MSA_blocks', type=int, default=2)
    parser_GCNA.add_argument('--mapping_weight', type=float, default=10)
    parser_GCNA.add_argument('--model_type', type=int, default=1)
    parser_GCNA.add_argument('--input_type', type=str, default='mt') # mt t r
    parser_GCNA.add_argument('--act', type=str, default='tanh')
    parser_GCNA.add_argument('--train_dict',          default="/home/bigdata/thomas/dataspace/graph/econ-mahindas/semi-synthetic/dictionaries/node,split=0.2.train.dict")
    parser_GCNA.add_argument('--full_dict', default="/home/bigdata/thomas/dataspace/graph/econ-mahindas/semi-synthetic/dictionaries/groundtruth")
    parser_GCNA.add_argument('--log', action="store_true")
    parser_GCNA.add_argument('--invest', action="store_true")
    parser_GCNA.add_argument('--input_dim', default=100)
    parser_GCNA.add_argument('--loss_type', default=1, type=int, help="1 if normal, 2 if negative")
    parser_GCNA.add_argument('--linkpred', action='store_true')
...
do
    ...
    do
            ...
            do
                ...
                --pale_map_epochs 100 \
                --embedding_dim 250 \
                --cuda > output/GCNA/econ_d2_ls${ls}_msab${msab}_sep_jump
...
do
    ...
    do
            ...
            do
                ...
                --pale_map_epochs 100 \
                --embedding_dim 250 \
                --cuda > output/GCNA/econ_d2_ls${ls}_msab${msab}_sep
...
do
    ...
    --num_MSA_blocks 3 \
    --log \
    --cuda > output/GCNA/bn_d${d}_del_nodes
done
...
do
    ...
    --log \
    --cuda \
    --invest > output/GCNA/bn_del_nodes_d${d}
done
...
do
    ...
    --log \
    --cuda \
    --invest > output/GCNA/bn_del_edges_d${d}
done
...
do
    ...
    --log \
    --cuda \
    --invest > output/GCNA/econ_del_nodes_d${d}
done
...
do
    ...
    --log \
    --cuda \
    --invest > output/GCNA/ppi_del_edges_d${d}
done
