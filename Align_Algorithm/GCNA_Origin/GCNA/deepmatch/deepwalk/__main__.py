...
from deepmatch.deepwalk import graph
from deepmatch.deepwalk import walks as serialized_walks
...
def process(edge_list, undirected=True, number_walks=10, walk_length=40, window_size=5, workers=1, dimensions=64, max_memory_data_size=1000000000, seed=0, vertex_freq_degree=False):
    ...
    #  print("Training...")
        print("walks_done")
        model = Word2Vec(walks, size=dimensions, window=window_size, min_count=10, workers=workers)
    # else:
