...
class FINAL(NetworkAlignmentModel):
    ...
    def align(self):
        ...
        if not self.no_edge_feat:
            T1 = np.zeros_like(self.A1).A
            T2 = np.zeros_like(self.A2).A
...
if __name__ == "__main__":
    ...
    model = FINAL(source_dataset, target_dataset, None, args.alpha, args.max_iter, args.tol, args.train_dict)
    S = model.align()
